...
$(document).ready(function () {
    ...
    function IBatNewRow() {
        ...
        let whValue_P =
            CurrentBatchItemRow_P
                ? CurrentBatchItemRow_P.find(".JIDNI_WH_Number").val()
                : "";

        row.find(".JIRNI_BCH_WH_Number").val(whValue_P);
    ...
    $(document).on("click", ".ItemBatch_P", function () {
        ...
        setTimeout(() => {
            ...
            newRow.find(".JIRNI_BCH_Number").focus();
        }, 200);
    ...
    $(document).on('input', "#IBatTableBody_P tr.IBatNewRow input.JIRNI_BCH_Number", function () {
        ApplyIBatFieldWidths("P");
    });

    // ✅ Qty → Value calculation
    $(document).on('input', "#IBatTableBody_P tr.IBatNewRow input.JIRNI_BCH_BatchQty,#IBatTableBody_P tr.IBatNewRow input.JIRNI_BCH_BatchUnitPrice", function () {
