...
namespace ERP.Controllers
{
            ...
            var addresses = new List<DeliveryNoteAddress_DTO>
    {
        ...
        public IActionResult Index()
        {
            ...
            return View("~/Views/JobworkInward/Conversion/Index.cshtml", DN_DTO);
        }
            ...
            string? PageFilter)
        {
            Conversion_List_summary = ConversionSummaryGetData(
                ...
                PageFilter);
            ViewBag.Collapse = true;
            return View("~/Views/JobworkInward/Conversion/ConversionSummary.cshtml",
      ...
      string? PageFilter)
        {
            Conversion_List = ConversionDetailedGetData(
                ...
                PageFilter);
            ViewBag.Collapse = true;
            return View("~/Views/JobworkInward/Conversion/ConversionDetailed.cshtml",
