...
namespace ERP.Controllers.JobworkInward
{
    public class FreightInvoiceController : Controller
    {
        ...
        public IActionResult Create()
        {
            GetFreightInvoiceData();
            ViewBag.Collapse = true;
            return View("~/Views/JobworkInward/FreightInvoice/Create.cshtml");
        }
        ...
        public JsonResult GetDeliveryNote_ForFreightInvoice(long CustomerNumber, string DNNumbers)
        {
            ...
            var data = dt.AsEnumerable().Select(r => new
            {
                ...
                JIDNI_UnitPrice = r["JIDNI_UnitPrice"] == DBNull.Value ? 0 : Convert.ToDecimal(r["JIDNI_UnitPrice"]),
                JIDNI_Amount = r["JIDNI_Amount"] == DBNull.Value ? 0 : Convert.ToDecimal(r["JIDNI_Amount"]),
                Freight_Applicable = r["JIDNI_IsFreightApplicable"] == DBNull.Value ? "" : r["JIDNI_IsFreightApplicable"].ToString(),
                Freight_ServiceOrder_Number = r["JIDNI_JIFRT_SVOH_Number"] == DBNull.Value ? "" : r["JIDNI_JIFRT_SVOH_Number"].ToString(),
                fromWH = r["fromWH"] == DBNull.Value ? 0 : Convert.ToInt64(r["fromWH"]),
                toWH = r["toWH"] == DBNull.Value ? 0 : Convert.ToInt64(r["toWH"]),
                // NEW: mirrors Jobwork's hasServiceOrder/serviceOrderNo/jisvoI_UnitPrice
                hasServiceOrder = r["hasServiceOrder"] == DBNull.Value ? 0 : Convert.ToInt32(r["hasServiceOrder"]),
                serviceOrderNo = r["serviceOrderNo"] == DBNull.Value ? "" : r["serviceOrderNo"].ToString(),
                jisvoH_Number = r["jisvoH_Number"] == DBNull.Value ? 0 : Convert.ToInt64(r["jisvoH_Number"]),
        ...
        public JsonResult GetReceiptNote_ForFreightInvoice(long CustomerNumber, string RNNumbers)
        {
            ...
            var data = dt.AsEnumerable().Select(r => new
            {
                ...
                JIRNI_Freight_Applicable = r["JIRNI_IsFreightApplicable"] == DBNull.Value ? "" : r["JIRNI_IsFreightApplicable"].ToString(),
                JIRNI_Freight_ServiceOrder_Number = r["JIRNI_JIFRT_SVOH_Number"] == DBNull.Value ? "" : r["JIRNI_JIFRT_SVOH_Number"].ToString(),
                fromWH = r["fromWH"] == DBNull.Value ? 0 : Convert.ToInt64(r["fromWH"]),
                toWH = r["toWH"] == DBNull.Value ? 0 : Convert.ToInt64(r["toWH"]),
                hasServiceOrder = r["hasServiceOrder"] == DBNull.Value ? 0 : Convert.ToInt32(r["hasServiceOrder"]),
                serviceOrderNo = r["serviceOrderNo"] == DBNull.Value ? "" : r["serviceOrderNo"].ToString(),
        ...
        public JsonResult GetFreightInvoiceAddress(long FRTIH_Number)
        {
            ...
            var data = dt.AsEnumerable().Select(r => new
            {
                JIFTIA_Number = r["JIFTIA_Number"] == DBNull.Value ? 0 : Convert.ToInt64(r["JIFTIA_Number"]),
                JIFTIA_ADTP_Number = r["JIFTIA_ADTP_Number"] == DBNull.Value ? 0 : Convert.ToInt64(r["JIFTIA_ADTP_Number"]),
                JIFTIA_Address_ID = r["JIFTIA_Address_ID"] == DBNull.Value ? "" : r["JIFTIA_Address_ID"].ToString(),
                JIFTIA_Address = r["JIFTIA_Address"] == DBNull.Value ? "" : r["JIFTIA_Address"].ToString(),
                JIFTIA_City = r["JIFTIA_City"] == DBNull.Value ? "" : r["JIFTIA_City"].ToString(),
                JIFTIA_State = r["JIFTIA_State"] == DBNull.Value ? "" : r["JIFTIA_State"].ToString(),
                JIFTIA_Country = r["JIFTIA_Country"] == DBNull.Value ? "" : r["JIFTIA_Country"].ToString(),
                JIFTIA_PIN = r["JIFTIA_PIN"] == DBNull.Value ? "" : r["JIFTIA_PIN"].ToString(),
                JIFTIA_GSTIN = r["JIFTIA_GSTIN"] == DBNull.Value ? "" : r["JIFTIA_GSTIN"].ToString()
            }).ToList();
        ...
        public IActionResult FreightInvoiceSummary(String? SortOrder, String? Search, Int32? PageNumber, Int32 PSize, String? PageFilter)
        {
            ...
            ViewBag.Collapse = true; return View("~/Views/JobworkInward/FreightInvoice/FreightInvoiceSummary.cshtml", PaginatedList_DTO<FreightInvoiceSummary_DTO>.CreateAsync(FRT_List, DPageNumber ?? 1, DPageSize));
        }
        ...
        public IActionResult FreightInvoiceSummary(String? SortOrder, String? Search, Int32? PageNumber, Int32 PSize, String? PageFilter, String? Mode, String? DeleteNumbers, String? SI_No, String[] DeleteNumber, String selectAllCheckbox)
        {
            ...
            FRT_List = FRTSummaryGetData(SortOrder, Search, PageNumber, PSize, PageFilter);
            return View("~/Views/JobworkInward/FreightInvoice/FreightInvoiceSummary.cshtml", PaginatedList_DTO<FreightInvoiceSummary_DTO>.CreateAsync(FRT_List, DPageNumber ?? 1, DPageSize));
        }
        ...
        List<FreightInvoiceSummary_DTO> FRTSummaryGetData(String? SortOrder, String? Search, Int32? PageNumber, Int32 PSize, String? PageFilter)
        {
            ...
            var Key = FRT_List.OrderByDescending(Cs => Cs.JIFTIH_Number);
            if (!String.IsNullOrEmpty(Search))
            {
                Key = Key.Where(K => K.JIFTIH_InvoiceDate.ToString().ToLower().Contains(Search.ToLower()) ||
                K.JIFTIH_InvoiceNo.ToString().ToLower().Contains(Search.ToLower()) ||
                ...
                K.TotalQty.ToString().ToLower().Contains(Search.ToLower())).OrderByDescending(Cs => Cs.JIFTIH_Number);
            }

            switch (SortOrder)
            {
                case "Title_desc":
                    Key = Key.OrderByDescending(K => Convert.ToDateTime(K.JIFTIH_InvoiceDate)!);
                    break;
                case "Title":
                    Key = Key.OrderBy(K => Convert.ToDateTime(K.JIFTIH_InvoiceDate)!);
                    break;
                default:
                    Key = Key.OrderByDescending(K => K.JIFTIH_InvoiceDate);
                    break;
            }
        ...
        public IActionResult FreightInvoiceDetailed(String? SortOrder, String? Search, Int32? PageNumber, Int32 PSize, String? PageFilter)
        {
            ...
            ViewBag.Collapse = true;
            return View("~/Views/JobworkInward/FreightInvoice/FreightInvoiceDetailed.cshtml", PaginatedList_DTO<FreightInvoiceDetail_DTO>.CreateAsync(FRT_List_detail, DPageNumber ?? 1, DPageSize));
        }
        ...
        List<FreightInvoiceDetail_DTO> FRTDetailedGetData(String? SortOrder, String? Search, Int32? PageNumber, Int32 PSize, String? PageFilter)
        {
            ...
            var Key = FRT_List_detail.OrderByDescending(Cs => Cs.JIFTIH_Number);
            if (!String.IsNullOrEmpty(Search))
            {
                Key = Key.Where(K => K.JIFTIH_InvoiceDate.ToString().ToLower().Contains(Search.ToLower()) ||
                K.JIFTIH_InvoiceNo.ToString().ToLower().Contains(Search.ToLower()) ||
                K.CUS_Name.ToString().ToLower().Contains(Search.ToLower()) ||
                K.CurrencyCode.ToString().ToLower().Contains(Search.ToLower()) ||
                K.JIFTII_Amount.ToString().ToLower().Contains(Search.ToLower()) ||
                K.JIFTII_Qty_Kgs.ToString().ToLower().Contains(Search.ToLower())).OrderByDescending(Cs => Cs.JIFTIH_Number);
            }
            ...
            ViewBag.SumOfQty = Key.Sum(item => Convert.ToDouble(item.JIFTII_Qty_Kgs));
            ViewBag.SumOfAmount = Key.Sum(item => Convert.ToDouble(item.JIFTII_Amount));
            ViewBag.SumOfHeadGst = Key.Sum(item => Convert.ToDouble(item.JIFTII_GST_Amount));
        ...
        public JsonResult GetFreightServiceOrder(long customerId, string category, long? uomNumber = null, long? fromWHNumber = null, long? toWHNumber = null)
        {
            FreightInvoice_DAO dao = new FreightInvoice_DAO();

            var dt = dao.GetFreightServiceOrderDB(customerId, category, uomNumber, fromWHNumber, toWHNumber).Tables[0];
