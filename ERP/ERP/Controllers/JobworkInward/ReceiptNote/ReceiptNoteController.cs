...
namespace ERP.Controllers.JobworkInward
{
    public class ReceiptNoteController : Controller
    {
        ...
        public IActionResult RNNumbering()
        {
            ...
            GetRNNumber();
            return View("~/Views/JobworkInward/ReceiptNote/JIRN_Numbering.cshtml", PON_DTO);
        }
        ...
        public IActionResult ReciptNoteSummaryDetailed(String? SortOrder, String? Search, Int32? PageNumber, Int32 PSize, String? PageFilter)
        {
            ...
            return View("~/Views/JobworkInward/ReceiptNote/ReciptNoteSummaryDetailed.cshtml", PaginatedList_DTO<ReceiptNoteSummary_DTO>.CreateAsync(SIR_List, DPageNumber ?? 1, DPageSize));
        }
        ...
        public IActionResult ReciptNoteSummary(String? SortOrder, String? Search, Int32? PageNumber, Int32 PSize, String? PageFilter)
        {
            ...
            return View("~/Views/JobworkInward/ReceiptNote/ReciptNoteSummary.cshtml", PaginatedList_DTO<ReceiptNoteSummary_DTO>.CreateAsync(SIR_List, DPageNumber ?? 1, DPageSize));
